...
print("\n== 15. preview ==")
CALLBACK_MANAGER:FireCallbacks("LibHarvensAddonSettings_AddonSelected", Panel)
local frame = CreatedControls.PBsChatWindowCustomizerPreview
check("preview shown with the panel", frame and not frame.hidden, true)
...
CALLBACK_MANAGER:FireCallbacks("LibHarvensAddonSettings_AddonSelected", {})
check("another add-on's panel hides it", frame.hidden, true)
CALLBACK_MANAGER:FireCallbacks("LibHarvensAddonSettings_AddonSelected", Panel)
Panel.selected = false
AdvanceFrame(); frame:Tick()
check("leaving the panel hides it", frame.hidden, true)
Panel.selected = nil
CALLBACK_MANAGER:FireCallbacks("LibHarvensAddonSettings_AddonSelected", Panel)
CurrentScene = { name = "hud" }
AdvanceFrame(); frame:Tick()
check("leaving the scene hides it", frame.hidden, true)
Row(GetString(SI_PBSCWC_PREVIEW)).setFunction(false)
CurrentScene = { name = "gamepad_settings" }
CALLBACK_MANAGER:FireCallbacks("LibHarvensAddonSettings_AddonSelected", Panel)
check("preview switched off stays off", frame.hidden, true)
